...
function Placeholder() {
    return (
        <ContentLoader height={100} width={992} primaryColor="#E9E7E7" secondaryColor="#C6C2BF">
            <rect x="0" y="16" rx="5" ry="5" width="234" height="16" />
            <rect x="0" y="38" rx="5" ry="5" width="234" height="16" />
            <rect x="242" y="16" rx="5" ry="5" width="234" height="16" />
            <rect x="242" y="38" rx="5" ry="5" width="234" height="16" />
