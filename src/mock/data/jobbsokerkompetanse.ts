...
const jobbsokerkompetanse: KartleggingData & JSONValue = {
	...
	raad: [
		...
		},
		{
			...
			raadIngress:
				'Mange synes at intervju kan være litt skummelt og vanskelig. Det hjelper å forberede seg godt. Se tips til deg.',
			raadAktiviteter: [
				{
				...
				},
				{
					...
					innhold:
						'<p xmlns="">Forbered en kort, muntlig presentasjon som viser hvem du er som person, dine personlige egenskaper og interesser. Legg vekt på det du ikke har skrevet i CV-en og søknaden, det som sier noe om deg som menneske.</p>'
				},
				{
					tittel: 'Les papirene dine før intervjuet.',
					innhold:
						'<p xmlns="">Gå gjennom stillingsannonsen, søknaden og CV-en din på nytt før intervjuet.</p>'
				}
			]
		},
		{
	...
	besvarelse: [
		...
		},
		{
			...
			tips:
				'Hvis du registrerer CV-en din flere steder, er det større sjanse for at en arbeidsgiver vil finne deg.',
		...
		},
		{
			...
			tipsKey: 'tilpass-cv',
			tips:
				'Husk å tilpasse CV-en etter hva slags jobb du søker. Du bør fremheve det som er relevant for stillingen.',
		...
		},
		{
			...
			tips:
				'Arbeidsgiveren er opptatt av å høre om hvem du er og hva du kan tilføre bedriften. Forbered deg på å snakke om hvorfor akkurat du bør få jobben.',
			svarAlternativer: [
				{
