...
function PersonverninformasjonSykmeldt() {
	return (
		<div id="personverninformasjon-modal__innhold">
			<Heading size="2xlarge">Mer veiledning fra NAV</Heading>
			<Heading size="xlarge">Når du har registrert deg</Heading>
			<ul>
			...
			<div>
				...
				<Heading size="medium">Har du allerede registrert en CV eller jobbprofil? </Heading>
				<BodyShort>
