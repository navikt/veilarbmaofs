...
import Oppfolging, {
    OppfolgingData,
} from './app/visningskomponenter/oppfolging/oppfolging';
import Personalia, {
    IPersonaliaInfo,
} from './app/visningskomponenter/personalia/personalia';
...
export type VisningKomponent<T = {}> = React.ComponentType<{ data: T }> & {
...
): Array<IInformasjonsElement<any>> {
    return [
        {
            component: CV,
        ...
        },
        {
            ...
            dataSource: getData<{ jobbonsker: ArenaPerson }>({
                jobbonsker: `/pam-arena/rest/arenaperson/hentForFnr?fnr=${
                    context.fnr
                }`,
            }),
            id: 'Jobbønsker',
        ...
        },
        {
            ...
            dataSource: getData<{ oppfolging: OppfolgingData }>({
                oppfolging: `/veilarboppfolging/api/person/oppfolging/${
                    context.fnr
                }/oppfolgingsstatus`,
            }),
            id: 'Oppfølging',
